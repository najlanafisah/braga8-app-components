import 'package:braga8_app_components/views/dashboard/components/gradient_border_btn.dart';
...
class AccountModal extends StatelessWidget {
  ...
  const AccountModal({super.key, required this.user});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildInfoTile("Join Date", user.joinDate),
                    _buildInfoTile("Role", user.role),
                    SizedBox(width: 20),
                  ],
                ),
                SizedBox(height: 20),
                _buildInfoTile("Email", user.email, isFullWidth: true),
                SizedBox(height: 35),
